...
|                                          | 短期   | 中期   | 长期   |
| ---------------------------------------- | ---- | ---- | ---- |
| 阅读 [系统设计主题](/topics/) 以获得一个关于系统如何工作的宽泛的认识 | :+1: | :+1: | :+1: |
| 阅读一些你要面试的[公司工程博客](/topics/appendix#公司工程博客)的文章            | :+1: | :+1: | :+1: |
| 阅读 [真实架构](/topics/appendix#真实架构)                   | :+1: | :+1: | :+1: |
| 复习 **如何处理一个系统设计面试题**       | :+1: | :+1: | :+1: |
| 完成 [系统设计的面试题和解答](/interview/index)             | 一些   | 很多   | 大部分  |
| 完成 [面向对象设计的面试题和解答](/ood/index)        | 一些   | 很多   | 大部分  |
| 复习 [其它的系统设计面试题](/topics/appendix#其它的系统设计面试题)          | 一些   | 很多   | 大部分  |
...
* [系统设计的卡堆](https://github.com/donnemartin/system-design-primer/tree/master/resources/flash_cards/System%20Design.apkg)
* [系统设计的练习卡堆](https://github.com/donnemartin/system-design-primer/tree/master/resources/flash_cards/System%20Design%20Exercises.apkg)
* [面向对象设计的练习卡堆](https://github.com/donnemartin/system-design-primer/tree/master/resources/flash_cards/OO%20Design.apkg)
